      ...
      {items.length > 0 && (
        <div className="px-4 py-4 border-t-2 border-white/20 bg-white/5 flex-shrink-0">
          ...
          <div className="flex space-x-3">
            <button className="flex-1 bg-[#13ee9e] text-white py-3 px-4 rounded-lg font-medium transition-all duration-200 hover:bg-[#0fd189] transform hover:scale-[1.02] font-roboto shadow-lg">
              View Cart
            </button>
            <button className="flex-1 bg-white/10 text-white py-3 px-4 rounded-lg font-medium transition-all duration-200 hover:bg-white/20 backdrop-blur-sm font-roboto border border-white/20">
              Checkout
            </button>
          </div>
        </div>
